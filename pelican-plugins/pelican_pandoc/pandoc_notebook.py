...
def notebook(markup):
    ...
    template_file = 'basic'
    if IPYTHON_VERSION >= 3:
        if os.path.exists(os.path.join(os.path.realpath(__file__), 'pelicanhtml_3.tpl')):
            template_file = 'pelicanhtml_3'
    elif IPYTHON_VERSION == 2:
        if os.path.exists(os.path.join(os.path.realpath(__file__), 'pelicanhtml_2.tpl')):
            template_file = 'pelicanhtml_2'
    else:
        if os.path.exists(os.path.join(os.path.realpath(__file__), 'pelicanhtml_1.tpl')):
