...
There are also now a bunch of really awesome plugins written in pure lua. You can find a curated list [here](https://github.com/rockerBOO/awesome-neovim) and [here](http://neovimcraft.com/).
