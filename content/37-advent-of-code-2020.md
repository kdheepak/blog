...
For straightforward puzzles, it is a lot of fun to see who can read, grok and type out a bug-free working program that solves a problem the fastest.
...
For example, check out this terse solution by [Pablo Zubieta](https://github.com/pabloferz/AoC/blob/master/2020/04/Day4.jl):
