...
%% 2015/08/26
%% by Michael Shell
%% see https://www.michaelshell.org/
...
%% ( https://www.latex-project.org/ ) version 1.3, and may be freely used,
...
\documentclass[journal,10pt,final]{IEEEtran}
%
...
\hypersetup{unicode=true,
            pdftitle={Writing Technical Papers with Markdown},
            pdfkeywords={markdown, vim, writing, academic, scholarly, technical, scientific,
papers},
            pdfborder={0 0 0},
            breaklinks=true}
...
\author{ Dheepak Krishnamurthy~\IEEEmembership{} \and  % <-this % stops a space
\thanks{}% <-this % stops a space
}

% The paper headers

\markboth{White paper}%
